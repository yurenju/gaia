...
GAIA_KEYBOARD_LAYOUTS?=en,pt-BR,es,de,fr,fr-CA,pl,zh-Hans-Pinyin,en-Dvorak
...
# Generate profile/
$(PROFILE_FOLDER): preferences app test-agent-config offline contacts extensions $(XULRUNNER_BASE_DIRECTORY) .git/hooks/pre-commit create-default-data
ifeq ($(BUILD_APP_NAME),*)
...
$(PROFILE_FOLDER)/settings.json: $(XULRUNNER_BASE_DIRECTORY) profile-dir app
